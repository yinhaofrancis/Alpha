...
//}
//
//public protocol butterflyController{
//    var butterfly:butterfly<UIViewController>? { get set }
//    init(subRoute:[String]?,param:[String:Any]?)
//}

public class ControllerButterfly{
    
    public let store = butterfly<UIViewController>()
    
    public func register<T>(router:String,proto:T.Type,build:@escaping ()->UIViewController){
        self.store.register(router: Router(name: router + "\(proto)", build: build))
    }
